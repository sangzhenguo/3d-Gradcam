...
class UNet(nn.Module):
    ...
    def __init__(self, in_channels=1, n_classes=1, base_n_filter=36):
        ...
        self.upsacle = nn.Upsample(scale_factor=(1, 2, 2), mode='nearest')
        ...
        self.conv3d_c2 = nn.Conv3d(self.base_n_filter, self.base_n_filter * 2, kernel_size=(1, 3, 3), stride=(1, 2, 2), padding=(0, 1, 1),
                                   bias=False)
        self.norm_lrelu_conv_c2 = self.norm_lrelu_conv(self.base_n_filter * 2, self.base_n_filter * 2)
        self.inorm3d_c2 = nn.InstanceNorm3d(self.base_n_filter * 2)

        self.conv3d_c3 = nn.Conv3d(self.base_n_filter * 2, self.base_n_filter * 4, kernel_size=(1, 3, 3), stride=(1, 2, 2), padding=(0, 1, 1),
                                   bias=False)
        self.norm_lrelu_conv_c3 = self.norm_lrelu_conv(self.base_n_filter * 4, self.base_n_filter * 4)
        self.inorm3d_c3 = nn.InstanceNorm3d(self.base_n_filter * 4)

        self.conv3d_c4 = nn.Conv3d(self.base_n_filter * 4, self.base_n_filter * 8, kernel_size=(1, 3, 3), stride=(1, 2, 2), padding=(0, 1, 1),
                                   bias=False)
        self.norm_lrelu_conv_c4 = self.norm_lrelu_conv(self.base_n_filter * 8, self.base_n_filter * 8)
        self.inorm3d_c4 = nn.InstanceNorm3d(self.base_n_filter * 8)

        self.conv3d_c5 = nn.Conv3d(self.base_n_filter * 8, self.base_n_filter * 16, kernel_size=(1, 3, 3), stride=(1, 2, 2), padding=(0, 1, 1),
                                   bias=False)
    ...
    def forward(self, x):
        ...
        # print(ds1_ds2_sum_upscale.shape, ds3_1x1_conv.shape)
